...
export function Header({ eventCount, lastUpdated }: HeaderProps) {
  return (
    <header className="liquid-glass-strong sticky top-0 z-50 rounded-b-3xl border-0">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <span className="text-sm text-brand-black bg-brand-lime/90 px-4 py-2 rounded-full font-medium liquid-glass-button border-0">{eventCount} Events</span>
